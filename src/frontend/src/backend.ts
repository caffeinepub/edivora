...
import type { ExternalBlob as _ExternalBlob, Lesson as _Lesson, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addHomework(arg0: HomeworkItem): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAudio(): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAudio();
    ...
    async getCompletedLessons(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getHomework(): Promise<Array<HomeworkItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHomework();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLesson(arg0: bigint, arg1: string, arg2: bigint): Promise<Lesson | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLesson(arg0, arg1, arg2);
    ...
    async getLessonTitles(arg0: bigint, arg1: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessonTitles(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuestions(arg0: bigint, arg1: string): Promise<Array<QuizQuestion>> {
        if (this.processError) {
            try {
    ...
    async markHomeworkDone(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markHomeworkDone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAttempt(arg0: Array<QuizQuestion>, arg1: Array<bigint>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async uploadAudio(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadAudio(await to_candid_ExternalBlob_n16(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Lesson]): Lesson | null {
    return value.length === 0 ? null : value[0];
}
